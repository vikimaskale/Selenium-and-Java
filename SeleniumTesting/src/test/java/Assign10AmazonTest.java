...
public class Assign10AmazonTest {
...
//		Thread.sleep(3000);
		...
		//printing details of mobile and clicking on it
...
//		switching window
		...
		for(String window2: driver.getWindowHandles()) {
			if(window2.equals(window1) ==false) {
...
//		Thread.sleep(2000);
		...
		//click on enter card details
		driver.findElement(By.xpath("/html/body/div[3]/div/div/div/div/div/div/div[2]/div/div/div/div/form/div[2]/div/span[2]/span/input")).click();
